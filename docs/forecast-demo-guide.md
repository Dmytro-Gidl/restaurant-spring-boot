...
### Trend Taco (dish 100)
*History:* Quantities climb linearly from 8 to 112 over twenty-seven months. Both Holt–Winters and ARIMA have enough folds to train on this longer run, matching the dataset seeded by `forecast-demo.sql`.
